"use client"
import { readContext, writeContext } from "@/app/_context/api"
				...
				>
					...
					<div className="flex gap-4 items-center">
						...
						<div className="flex gap-4">
							<div
								className={`transition-all flex items-center gap-2 px-3 py-1 border-2 rounded-full cursor-pointer hover:scale-95 border-indigo-400`}
							>
								<Icon.Eye
							...
							<div
								className={`transition-all flex items-center gap-2 px-3 py-1 border-2 rounded-full cursor-pointer hover:scale-95 border-gray-300`}
							>
								<Icon.Buildings
					...
					<div className="flex gap-4 items-center">
						<div className="flex flex-col">
							...
							<p className="text-xs text-gray-300">
								Recommended Size <br /> 256px x 256px
							</p>
						</div>
						<input
							className=""
