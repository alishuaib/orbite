...
export default function ChatPage() {
	...
	return (
		<div className="relative flex border-2 border-gray-300 flex-1 rounded-md bg-gray-100 max-h-[750px]">
			<div className="relative flex flex-col flex-[3]">
				...
				<div className="relative flex w-1/3 p-2 self-center mt-auto bg-gray-300 rounded mb-4 items-center">
					<ChatInput
